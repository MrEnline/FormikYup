...
const MyTextInput = ({ label, ...props }) => {
    //field - получает onChange, onBlur, value из useField в виде объекта через контекст
    //meta - ошибки
...
const MyCheckbox = ({ children, ...props }) => {
    //field - получает onChange, onBlur, value из useField в виде объекта через контекст
    //meta - ошибки
    //children - может быть компонентом, а может быть обычным label
    //для чекбоксов указываем тип
